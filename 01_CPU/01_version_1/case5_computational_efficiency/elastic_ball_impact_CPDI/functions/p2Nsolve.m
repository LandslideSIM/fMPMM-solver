...
nX    = meD.DoF*no-1                                                      ;%
nY    = nX+1                                                              ;%
meD.p = accumarray([nX;nY],[mpD.S.*mpD.p(mp,1);mpD.S.*mpD.p(mp,2)],[meD.nDF(2) 1]);
meD.f = accumarray([   nY], mpD.S.*mpD.m(mp).*(-g),[meD.nDF(2) 1]);
meD.f = meD.f-accumarray([nX;nY],mpD.V([mp;mp]).*[(mpD.dSx.*mpD.s(1,mp)'+mpD.dSy.*mpD.s(4,mp)');...
...
clear m p f fi nX nY iDx iDy iD BCx BCy                                   ;% clear temporary variables
%-------------------------------------------------------------------------%
