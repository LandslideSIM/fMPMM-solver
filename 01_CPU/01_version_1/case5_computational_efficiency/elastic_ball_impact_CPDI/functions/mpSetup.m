function [mpD] = mpSetup(meD,ni,L,xinf,xsup,yinf,coh0,cohr,phi0,phir,n0,rho0,nstr,typeD)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%% MPM DISCRETIZATION
% layer initialization
xL      = xinf+(0.5*meD.h(1)/ni):meD.h(1)/ni:xsup   ;
yL      = yinf+(0.5*meD.h(2)/ni):meD.h(2)/ni:  L-(0.5*meD.h(2)/ni)       ;
[X,Y]   = meshgrid(xL,yL)                                                 ;
...
%% MATERIAL POINT:
% SCALAR & VECTOR
mpD.n  = length(X(:))                                                    ;% number of material point
