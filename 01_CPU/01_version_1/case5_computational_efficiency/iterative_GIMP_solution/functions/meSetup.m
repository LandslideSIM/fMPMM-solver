function [meD] = meSetup(nEx,typeD)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%% MESH INITIALIZATION
meD.vd  = 0.10                                                            ;% viscous damping coefficient
Lx      = 64.1584                                                              ;% mesh dimension (x,y)
nEy     = floor(0.25*nEx)                                                 ;% number of element in y direction
rel     = nEy/nEx                                                         ;% ratio between elements in x and y directions
meD.L   = [Lx rel.*Lx]                                                    ;% mesh length in x            [m]
