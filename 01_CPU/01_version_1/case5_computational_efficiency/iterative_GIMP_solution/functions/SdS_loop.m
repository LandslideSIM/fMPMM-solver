...
for mp=1:mpD.n
    ...
    mpD.B(:,:,mp) = 0.0;
    jx       = 1:meD.DoF:meD.nDF(1)                                       ;% x indexing
    jy       = 2:meD.DoF:meD.nDF(1)                                       ;% y indexing
    % B MATRIX ASSEMBLY
    mpD.B(1,jx,mp)= mpD.dSx(mp,:)'                                        ;% strain-displacement matrix
    mpD.B(2,jy,mp)= mpD.dSy(mp,:)'                                        ;% strain-displacement matrix
    mpD.B(4,jx,mp)= mpD.dSy(mp,:)'                                        ;% strain-displacement matrix
    mpD.B(4,jy,mp)= mpD.dSx(mp,:)'                                        ;% strain-displacement matrix
end
end
