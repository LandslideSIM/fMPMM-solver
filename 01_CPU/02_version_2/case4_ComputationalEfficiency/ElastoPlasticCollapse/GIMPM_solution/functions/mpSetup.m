function [mpD,p2] = mpSetup(meD,ni,ly,coh0,cohr,phi0,phir,n0,rho0,nstr,typeD)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%% MPM DISCRETIZATION
% layer initialization
lx      = 2*ly;
xL      = meD.xB(1)+(0.5*meD.h(1)/ni):meD.h(1)/ni:meD.xB(1)+lx   ;
yL      = meD.xB(3)+(0.5*meD.h(2)/ni):meD.h(2)/ni:  ly-(0.5*meD.h(2)/ni)       ;
