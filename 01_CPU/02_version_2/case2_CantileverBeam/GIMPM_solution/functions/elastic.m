...
mpD.s(1,:) = old_s(1,:).*cos2 + ...
             old_s(2,:).*sin2 - 2.*old_s(4,:).*sincos                     ;% primed sig_xx
mpD.s(2,:) = old_s(1,:).*sin2 + ...
             old_s(2,:).*cos2 + 2.*old_s(4,:).*sincos                     ;% primed sig_yy
mpD.s(4,:) =(old_s(1,:)-old_s(2,:)).*sincos + ...
             old_s(4,:).*(cos2-sin2)                                      ;% primed sig_xy/sig_yx       
%--------------------------------------------------------------------------%
